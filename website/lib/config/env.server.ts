...
const serverSchema = z.object({
  ...
  DEFAULT_FAST_MODEL: z.string().default('qwen/qwen3.8-27b'),
  DEFAULT_CHAT_MODEL: z.string().default('qwen/qwen3.8-27b'),
  ...
  RAG_DEFAULT_MODEL: z.string().default('qwen/qwen3.8-27b'),
  RAG_CHAT_MODEL: z.string().default('qwen/qwen3.8-27b'),
  RAG_MAX_CONTEXT_TOKENS: z.coerce.number().default(1600),
