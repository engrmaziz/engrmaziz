...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const interactiveElements = Array.from(document.querySelectorAll('a, button, [role="button"], input, textarea, select, label'))
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          pointerEvents: 'none',
          zIndex: 99998,
          transition: 'width 0.25s ease, height 0.25s ease, border-color 0.25s, background 0.25s, transform 0.18s ease',
          willChange: 'transform',
